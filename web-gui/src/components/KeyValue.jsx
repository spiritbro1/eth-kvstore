...
import { useContractRead, useAccount, useContractEvent,usePrepareContractWrite,useContractWrite } from 'wagmi'
...
export default function ColorTextFields() {
  ...
  return (
    ...
    <Collapse in={open}>
      ...
      <TextField disabled={loading} value={key} onChange={e => setKey(e.target.value)} fullWidth label="Key" />
      <TextField disabled={loading} value={value} onChange={e => setValue(e.target.value)} style={{ marginTop: 10 }} fullWidth label="Value" />
      ...
      <Button disabled={loading} style={{ marginTop: 5 }} onClick={storeKeyValue} variant="contained">Store</Button>
    </Box>
  );
}
